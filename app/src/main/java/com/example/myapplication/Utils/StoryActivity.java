...
public class StoryActivity extends AppCompatActivity implements StoriesProgressView.StoriesListener {
    ...
    ImageView image, story_photo,story_plus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        story_plus=findViewById(R.id.story_plus);
       // story_username = findViewById(R.id.story_username);
        ...
        story_photo.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                startActivity(intent);
    ...
    private void userInfo(String userid){
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference(mContext.getString(R.string.dbname_user_account_settings))
                .child(userid);
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                UserAccountSettings user = dataSnapshot.getValue(UserAccountSettings.class);
                Glide.with(getApplicationContext()).load(user.getProfile_photo()).into(story_photo);
